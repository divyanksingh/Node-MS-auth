exports.creds = {
  // Required
  identityMetadata: 'https://login.microsoftonline.com/007ea6f1-0979-473e-b34a-368850ca1502/v2.0/.well-known/openid-configuration', 
  ...
  clientID: 'ae41392d-dee1-4302-8fdd-412de7de08ca',
  ...
  redirectUrl: 'https://localhost:3001/auth/openid/return', 
  ...
  clientSecret: 'vqY-WraMS3y1LiA5_Bo8gO]Vb=2:7.tW', 
...
exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://localhost:3001';
